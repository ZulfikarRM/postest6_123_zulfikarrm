...
import 'package:postest6_123_zulfikarrm/alert.dart';
...
Widget tabBarBody() {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('postest6_123_zulfikarrm'),
